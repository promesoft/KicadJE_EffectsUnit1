...
#define LFO1 6 // Sets Pin PWM1 = Out 6 (top right)
#define LFO2 11 // Sets Pin PWM2 = Out 11 (mid right)
#define LFO3 10 // Sets Pin PWM6 = Out 10 (top left)
#define LFO4 9 // Sets Pin PWM4 = Out 9 (mid left)
